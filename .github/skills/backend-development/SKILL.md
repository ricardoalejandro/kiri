...
description: Build high-performance, optimized Go/Fiber backend services for Kiri CRM. Use when modifying API handlers, repository queries, services, domain entities, database migrations, Kommo sync, or WhatsApp integration. Enforces performance-first patterns, efficient SQL, proper indexing, caching, and zero-waste architecture.
---
...
backend/
  ...
  internal/
    ...
    kommo/
      ...
      sync.go                      → One-way Kommo → Kiri sync worker (5s polling)
...
import (
    ...
    // internal
    "kiri/internal/domain"
    "kiri/internal/repository"
)
```
