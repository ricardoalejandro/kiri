...
description: Enforce code quality, self-testing, and verification standards for Kiri CRM. Use this skill to ensure every change is compiled, deployed, and validated before presenting to the user. Acts as a senior engineer code review checklist.
user-invokable: false
---

# Quality Assurance — Kiri CRM
