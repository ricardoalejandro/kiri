...
description: Create beautiful, polished, and highly usable Next.js/React/TypeScript interfaces for Kiri CRM. Use when creating or modifying dashboard pages, components, API calls, WebSocket listeners, or UI styling. Enforces visual excellence, micro-interactions, accessibility, and the emerald/slate design system.
---

# Frontend Development — Kiri CRM
