          ...
          <div>
            ...
            <div className="mt-3 flex items-center gap-2">
              <span className="text-[10px] font-mono bg-white/70 text-emerald-800 px-2 py-1 rounded border border-emerald-200">
                https://kiri.naperu.cloud/mcp/sse
              </span>
              <button
                onClick={() => handleCopy('https://kiri.naperu.cloud/mcp/sse')}
        ...
        <div className="space-y-4 text-xs text-slate-600 leading-relaxed">
          ...
          <div className="flex items-start gap-3 bg-slate-50 rounded-xl p-3">
            ...
            <div>
              ...
              <div className="text-slate-500 mt-1 space-y-1">
                <p>• <strong>Nombre:</strong> Kiri</p>
                <p>• <strong>URL del servidor MCP:</strong> <code className="bg-white px-1 py-0.5 rounded border border-slate-200">https://kiri.naperu.cloud/mcp/sse</code></p>
                <p>• <strong>Autenticación:</strong> OAuth</p>
                <p>• <strong>URL de autorización:</strong> <code className="bg-white px-1 py-0.5 rounded border border-slate-200">https://kiri.naperu.cloud/mcp/authorize</code></p>
                <p>• <strong>URL del token:</strong> <code className="bg-white px-1 py-0.5 rounded border border-slate-200">https://kiri.naperu.cloud/mcp/token</code></p>
          ...
          <div className="flex items-start gap-3 bg-slate-50 rounded-xl p-3">
            ...
            <div>
              ...
              <p className="text-slate-500 mt-0.5">Se abrirá una ventana para iniciar sesión en Kiri. Luego podrás preguntar: &quot;¿Cuántos eventos activos tengo?&quot;, &quot;Dame el resumen de la bitácora del 7 de marzo&quot;, &quot;¿Qué dice la conversación con Lucero?&quot;</p>
            </div>
          </div>
        </div>
              ...
              {integrationView === 'google' && (
                <>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1">
                      Sincroniza contactos de Kiri a Google Contacts para que WhatsApp muestre los nombres en tu teléfono Android.
                    </p>
                  </div>
